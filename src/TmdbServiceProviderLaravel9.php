...
class TmdbServiceProviderLaravel9 extends ServiceProvider {
    ...
    public function register()
    {
        ...
        $this->app->bind('Tmdb\Laravel\Adapters\EventDispatcherAdapter', 'Tmdb\Laravel\Adapters\EventDispatcherLaravel9');
    }
